...
network_name="${PROVCONT_LAB_NETWORK:-provcont-lab}"
bridge_name="${PROVCONT_LAB_BRIDGE:-virbr202}"
host_ip="${PROVCONT_LAB_HOST_IP:-192.168.202.1}"
netmask="${PROVCONT_LAB_NETMASK:-255.255.255.0}"
dhcp_start="${PROVCONT_LAB_DHCP_START:-192.168.202.10}"
dhcp_end="${PROVCONT_LAB_DHCP_END:-192.168.202.254}"
